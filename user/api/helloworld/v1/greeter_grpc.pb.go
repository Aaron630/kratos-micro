...
func (c *greeterClient) GetOrderForm(ctx context.Context, in *GetOrderFormRequest, opts ...grpc.CallOption) (*GetOrderFormReply, error) {
	out := new(GetOrderFormReply)
	err := c.cc.Invoke(ctx, "/helloworld.v1.Greeter/GetOrderForm", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreeterServer) GetOrderForm(context.Context, *GetOrderFormRequest) (*GetOrderFormReply, error) {
...
func _Greeter_GetOrderForm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrderFormRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).GetOrderForm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.v1.Greeter/GetOrderForm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).GetOrderForm(ctx, req.(*GetOrderFormRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Greeter_GetOrderForm_Handler,
		},
		{
			MethodName: "Login",
